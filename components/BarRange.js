...
class BarRange extends React.Component {
  ...
  valuesmonthly = [
     { thread:'100',  pricethread:'$1.99', price:'$199.00' },
     { thread:'200',  pricethread:'$1.50', price:'$299.00' },
     { thread:'500',  pricethread:'$1.20', price:'$599.00' },
     { thread:'1000', pricethread:'$1.10', price:'$1,099.00' },
     { thread:'2000', pricethread:'$1.00', price:'$1,999.00' },
     { thread:'5000', pricethread:'$0.88', price:'$4,399.00' },
    ];

    valuesyearly = [
      { thread:'100',  pricethread:'$1.67', price: '$1,999.00' },
      { thread:'200',  pricethread:'$1.25', price:'$2,999.00' },
      { thread:'500',  pricethread:'$1.00', price:'$5,999.00' },
      { thread:'1000', pricethread:'$0.92', price:'$10,999.00' },
      { thread:'2000', pricethread:'$0.83', price:'$19,999.00' },
      { thread:'5000', pricethread:'$0.73', price:'$43,999.00' },
     ];
      ...
      <>
           <div className={styles.d_flex} >
                  <div className='labels'>
                     <h6><b>Number Of Threads</b> <span> 
                       <output  id="output">
                         {this.state.values[this.state.currentStepIndex].thread}
                       </output></span>
                       </h6>
                       <h6><b>Price per Threads </b>
